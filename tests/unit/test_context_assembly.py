...
def test_engine_composes_experiment_contract_and_worktree_lease_services(
    ...
    assert isinstance(
        engine.evolution_mutation_author_receipt_store,
        EvolutionMutationAuthorReceiptStore,
    )
    assert isinstance(
    ...
    assert isinstance(
        engine.evolution_decision_state_builder,
        EvolutionDecisionStateBuilder,
    )
    assert isinstance(
        engine.evolution_decision_state_store,
        EvolutionDecisionStateStore,
    )
    assert isinstance(
    ...
    assert isinstance(
        engine.evolution_promotion_package_input_builder,
        EvolutionPromotionPackageInputBuilder,
    )
    assert isinstance(
        engine.evolution_promotion_package_input_store,
        EvolutionPromotionPackageInputStore,
    )
    assert isinstance(
    ...
    assert isinstance(
        engine.evolution_promotion_approval_requirement_builder,
        EvolutionPromotionApprovalRequirementBuilder,
    )
    assert isinstance(
        engine.evolution_promotion_approval_requirement_store,
        EvolutionPromotionApprovalRequirementStore,
    )
    assert isinstance(
        engine.evolution_promotion_approval_requirement_executor,
        EvolutionPromotionApprovalRequirementExecutor,
    )
    assert isinstance(
        engine.evolution_promotion_approval_response_builder,
        EvolutionPromotionApprovalResponseBuilder,
    )
    assert isinstance(
        engine.evolution_promotion_approval_response_store,
        EvolutionPromotionApprovalResponseStore,
    )
    assert isinstance(
    ...
    assert isinstance(
        engine.evolution_promotion_approval_decision_builder,
        EvolutionPromotionApprovalDecisionBuilder,
    )
    assert isinstance(
        engine.evolution_promotion_approval_decision_store,
        EvolutionPromotionApprovalDecisionStore,
    )
    assert isinstance(
    ...
    assert isinstance(
        engine.evolution_evaluation_lane_receipt_builder,
        EvolutionEvaluationLaneReceiptBuilder,
    )
    assert isinstance(
        engine.evolution_evaluation_lane_receipt_store,
        EvolutionEvaluationLaneReceiptStore,
    )
    assert isinstance(
        engine.evolution_evaluation_lane_receipt_executor,
        EvolutionEvaluationLaneReceiptExecutor,
    )
    assert isinstance(
        engine.evolution_evaluation_aggregation_contract_builder,
        EvolutionEvaluationAggregationContractBuilder,
    )
    assert isinstance(
        engine.evolution_evaluation_aggregation_contract_store,
        EvolutionEvaluationAggregationContractStore,
    )
    assert isinstance(
    ...
    assert isinstance(
        engine.evolution_revalidation_opt_in_deployment_intent_store,
        EvolutionRevalidationOptInDeploymentIntentStore,
    )
    assert isinstance(
        engine.evolution_revalidation_opt_in_deployment_intent_service,
        EvolutionRevalidationOptInDeploymentIntentService,
    )
    assert (
        engine.evolution_revalidation_opt_in_deployment_intent_store.release_root
        == engine.evolution_release_slot_store.release_root
    )
    assert isinstance(
        engine.evolution_revalidation_opt_in_deployment_store,
        EvolutionRevalidationOptInDeploymentStore,
    )
    assert isinstance(
        engine.evolution_revalidation_opt_in_deployment_service,
        EvolutionRevalidationOptInDeploymentService,
    )
    assert (
