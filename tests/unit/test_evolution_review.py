...
def test_agent_tools_keep_read_and_write_authority_separate(tmp_path: Path) -> None:
    ...
    assert isinstance(tools[42], EvolutionPostRollbackRemoteLanePlacementTool)
    assert isinstance(tools[43], EvolutionPostRollbackTargetBaselineTool)
    assert isinstance(tools[44], EvolutionPostRollbackRemoteDispatchTool)
    assert isinstance(tools[45], EvolutionPostRollbackRemoteClaimTool)
    assert isinstance(tools[46], EvolutionPostRollbackRemoteDeliveryTool)
    assert isinstance(tools[47], EvolutionPostRollbackRemoteExecutionAuthorizationTool)
    assert isinstance(tools[48], EvolutionPostRollbackRemoteResultTool)
    assert isinstance(tools[49], EvolutionProposalQueueTool)
