...
@pytest.mark.asyncio
async def test_run_evolve_uses_file_path_when_target_file_is_blank() -> None:
    tool = _FakeTool()
    engine = _EngineToolCallFake("self_modify", tool)
    engine.tool_registry["self_evolve"] = object()
    engine._router.response_content = json.dumps(
...
@pytest.mark.asyncio
async def test_run_evolve_uses_content_when_new_content_is_blank() -> None:
    tool = _FakeTool()
    engine = _EngineToolCallFake("self_modify", tool)
    engine.tool_registry["self_evolve"] = object()
    engine._router.response_content = json.dumps(
...
@pytest.mark.asyncio
async def test_run_evolve_accepts_updated_content_alias() -> None:
    tool = _FakeTool()
    engine = _EngineToolCallFake("self_modify", tool)
    engine.tool_registry["self_evolve"] = object()
    engine._router.response_content = json.dumps(
        {
            "target_file": "tools/analysis.py",
            "updated_content": "# improved content\n",
            "description": "改进分析工具",
        },
        ensure_ascii=False,
    )
...
@pytest.mark.asyncio
async def test_run_evolve_accepts_proposal_wrapper_object() -> None:
    tool = _FakeTool()
    engine = _EngineToolCallFake("self_modify", tool)
    engine.tool_registry["self_evolve"] = object()
    engine._router.response_content = json.dumps(
...
@pytest.mark.asyncio
async def test_run_evolve_accepts_result_wrapper_object() -> None:
    tool = _FakeTool()
    engine = _EngineToolCallFake("self_modify", tool)
    engine.tool_registry["self_evolve"] = object()
    engine._router.response_content = json.dumps(
...
@pytest.mark.asyncio
async def test_run_evolve_accepts_single_change_list_object() -> None:
    tool = _FakeTool()
    engine = _EngineToolCallFake("self_modify", tool)
    engine.tool_registry["self_evolve"] = object()
    engine._router.response_content = json.dumps(
