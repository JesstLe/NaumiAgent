...
def test_new_ui_command_index_is_complete_deterministic_and_unique() -> None:
    ...
    assert by_name["/evolution"].arguments.syntax == (
        "[list|detail|evaluation|stable-population-preview|stable-population-completion|stable-rollback-readiness|stable-rollout-authorization|decision-*|reflection-*|promotion-*|approval-*|"
