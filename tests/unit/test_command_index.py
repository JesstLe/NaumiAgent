...
def test_new_ui_command_index_is_complete_deterministic_and_unique() -> None:
    ...
    assert by_name["/evolution"].arguments.syntax == (
        "[list|priorities|detail|discover-goal|discover-miss|discover-metric|discover-outcome|evaluation|stable-*|remote-*|rollout-*|decision-*|"
        "reflection-*|promotion-*|approval-request|approval-principal|approval-decision|"
        "approval-signature|approval-*|revalidation-*|outcome-*|enqueue] [arguments]"
    )
