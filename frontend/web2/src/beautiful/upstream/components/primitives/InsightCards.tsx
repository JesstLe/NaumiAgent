...
export function AllocationCard({ segments = ALLOCATION_SEGMENTS, title = 'Vanilla allocation', description = 'Contribution snapshot across current inventory value. Segment selection changes the inspected group without moving the card.', badge = 'V' }: { segments?: AllocationSegment[]; title?: string; description?: string; badge?: string }) {
...
export default function InsightCards({
  ...
  const { key, prose, Card, pill } = pages[page % pages.length];
