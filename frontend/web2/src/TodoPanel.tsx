...
import { CheckCircle2, ChevronDown, Circle, CircleDashed, RefreshCw, Plus, ListChecks } from 'lucide-react'
...
export function TodoPanel({ compact = false, onExpand }: { compact?: boolean; onExpand?: () => void }) {
  ...
  if (compact) return <button className="w2-todo-inline w2-todo-progress" onClick={onExpand}><ListChecks size={15} />待办进度 <span>{open.length} 项未完成</span></button>
