...
def harness_sandbox_eval_progress_payload(
    ...
    *,
    ...
    return {
        ...
        "admission_ticket_id": checkpoint.admission_ticket_id or "",
        "admission_epoch": checkpoint.admission_epoch or 0,
        "admission_state": checkpoint.admission_state or "",
        "queue_position": checkpoint.queue_position,
        "max_active": checkpoint.max_active,
        "max_queued": checkpoint.max_queued,
        "active_count": checkpoint.active_count,
        "queued_count": checkpoint.queued_count,
