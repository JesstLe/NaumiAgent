...
def _build_commands() -> list[CommandMeta]:
    ...
    return [  # noqa: E501
        ...
        CommandMeta("/keybindings", "显示当前快捷键配置", category="基础"),
        CommandMeta("/style", "显示当前主题和输出风格", category="基础"),
        ...
        CommandMeta("/harness", "Harness Profile、Sandbox 评测、Baseline、运行解释、知识、检查与信任", takes_arg=True, arg_hint="[status|doctor|explain|replay|detail|evidence|eval|baseline|knowledge|check|trust|untrust]", readonly=False, category="基础"),
        ...
        CommandMeta(
            ...
            takes_arg=True,
            arg_hint="[list|detail|evaluation|decision-*|reflection-*|promotion-*|approval-*|revalidation-*|revalidation-rollback-execute|revalidation-rollback-outcome|outcome-before-after|outcome-verify-runtime|outcome-verify-behavior|outcome-behavior-coverage|outcome-behavior-matrix|outcome-place-behavior|outcome-resolve-behavior|outcome-dispatch-behavior|outcome-claim-behavior|outcome-deliver-behavior|outcome-authorize-behavior|outcome-ingest-behavior|enqueue]",
            readonly=False,
            category="基础",
        ),
        CommandMeta(
            ...
            "复制/导出记录或权威完成回执",
            takes_arg=True,
            arg_hint="<all|last|error|receipt [receipt-id|latest]>",
            readonly=True,
            category="基础",
        ),
        ...
        CommandMeta("/permissions", "显示待确认权限面板", readonly=True, category="基础"),
        CommandMeta("/pwd", "显示当前工作目录", category="基础"),
        CommandMeta("/q", "退出", readonly=False, category="基础"),
        ...
        CommandMeta("/glob", "按 glob 规则搜索工作区文件路径", takes_arg=True, arg_hint="<pattern> [directory='.' ]", readonly=True, category="基础"),
        CommandMeta("/grep", "搜索文件内容（可配置过滤）", takes_arg=True, arg_hint="<pattern> [path='.']", readonly=True, category="基础"),
        CommandMeta("/read", "读取文件内容", takes_arg=True, arg_hint="<path> [offset=0] [limit=-1]", readonly=True, category="基础"),
        CommandMeta("/file_read", "读取文件内容", takes_arg=True, arg_hint="<path> [offset=0] [limit=-1]", readonly=True, category="基础"),
        CommandMeta("/write", "写入文件（覆盖）", takes_arg=True, arg_hint="<path> <content>", readonly=False, category="基础"),
        CommandMeta("/file_write", "写入文件（覆盖）", takes_arg=True, arg_hint="<path> <content>", readonly=False, category="基础"),
        CommandMeta("/edit", "按文本替换更新文件", takes_arg=True, arg_hint="<path> <old_text> <new_text>", readonly=False, category="基础"),
        CommandMeta("/file_edit", "按文本替换更新文件", takes_arg=True, arg_hint="<path> <old_text> <new_text>", readonly=False, category="基础"),
        ...
        CommandMeta("/dspy", "DSPy 编译优化 — Prompt 工程优化", takes_arg=True, arg_hint="[描述]", readonly=True, category="分析"),
        CommandMeta("/graph", "图谱推演 — GraphRAG 拓扑分析", takes_arg=True, arg_hint="[路径]", readonly=True, category="分析"),
        ...
        CommandMeta("/team", "团队协议 — status/handoff/blocker/decision/request/result", takes_arg=True, arg_hint="<子命令>", readonly=False, category="元命令"),
        CommandMeta("/runtime", "运行时状态 — all/context/todo/team/subagent/hooks/resources", takes_arg=True, arg_hint="[分区]", readonly=True, category="元命令"),
        CommandMeta("/browse", "打开 URL 并显示 SoM 元素", takes_arg=True, arg_hint="<url>", readonly=False, category="元命令"),
        CommandMeta("/autobrowse", "自主浏览器任务", takes_arg=True, arg_hint="<任务>", readonly=False, category="元命令"),
        ...
        CommandMeta(
            "/tasks",
            "任务面板 — todo/subagent/background/browser",
            takes_arg=True,
            arg_hint="[detail <id>]",
            readonly=True,
            category="元命令",
        ...
        CommandMeta("/task-abort", "中止运行中的任务", takes_arg=True, arg_hint="<id>", readonly=False, category="元命令"),
        CommandMeta("/task-resume", "从手动控制中恢复任务", takes_arg=True, arg_hint="<id>", readonly=False, category="元命令"),
        CommandMeta("/scan", "快速安全扫描", takes_arg=True, arg_hint="<url>", readonly=True, category="元命令"),
        CommandMeta("/scan-full", "完整 25 模块安全扫描", takes_arg=True, arg_hint="<url>", readonly=True, category="元命令"),
        CommandMeta("/scan-report", "导出最新扫描报告", takes_arg=True, arg_hint="[format]", readonly=True, category="元命令"),
        CommandMeta("/scan-baseline", "保存扫描为基线", takes_arg=True, arg_hint="<url>", readonly=False, category="元命令"),
        CommandMeta("/btemplate-list", "列出浏览器任务模板", readonly=True, category="元命令"),
        CommandMeta("/btemplate-run", "从模板创建运行", takes_arg=True, arg_hint="<id>", readonly=False, category="元命令"),
        CommandMeta("/btemplate-compare", "比较模板运行结果", takes_arg=True, arg_hint="<id>", readonly=True, category="元命令"),
