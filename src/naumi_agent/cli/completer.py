...
def _build_commands() -> list[CommandMeta]:
    ...
    return [  # noqa: E501
        ...
        CommandMeta(
            ...
            takes_arg=True,
            arg_hint="[list|detail|discover-goal|discover-miss|discover-metric|discover-outcome|evaluation|stable-*|remote-*|rollout-*|decision-*|reflection-*|promotion-*|approval-*|revalidation-*|outcome-*|enqueue] [arguments]",
            readonly=False,
            category="基础",
        ),
        CommandMeta(
