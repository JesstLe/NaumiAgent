...
def _build_commands() -> list[CommandMeta]:
    ...
    return [  # noqa: E501
        ...
        CommandMeta(
            ...
            takes_arg=True,
            arg_hint="[list|detail|evaluation|decision-*|reflection-*|promotion-*|approval-*|revalidation-*|revalidation-rollback-execute|revalidation-rollback-outcome|outcome-before-after|outcome-verify-runtime|outcome-verify-behavior|outcome-behavior-coverage|outcome-place-behavior|outcome-resolve-behavior|outcome-dispatch-behavior|outcome-claim-behavior|outcome-deliver-behavior|outcome-authorize-behavior|enqueue]",
            readonly=False,
            category="基础",
        ),
        CommandMeta(
