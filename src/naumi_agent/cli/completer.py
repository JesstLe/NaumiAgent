...
def _build_commands() -> list[CommandMeta]:
    ...
    return [  # noqa: E501
        ...
        CommandMeta(
            ...
            takes_arg=True,
            arg_hint="[list|detail|evaluation|decision-state|decision-resolve|reflection|reflection-revoke|promotion-input|promotion-package|approval-requirement|enqueue]",
            readonly=False,
            category="基础",
        ),
