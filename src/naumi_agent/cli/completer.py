...
def _build_commands() -> list[CommandMeta]:
    ...
    return [  # noqa: E501
        ...
        CommandMeta("/harness", "Harness Profile 状态、重复评测、Baseline、运行解释、知识、检查与信任", takes_arg=True, arg_hint="[status|doctor|explain|replay|detail|evidence|eval|baseline|knowledge|check|trust|untrust]", readonly=False, category="基础"),
