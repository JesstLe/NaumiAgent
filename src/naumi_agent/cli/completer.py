...
def _build_commands() -> list[CommandMeta]:
    ...
    return [  # noqa: E501
        ...
        CommandMeta(
            ...
            takes_arg=True,
            arg_hint="[list|detail|evaluation|decision-*|reflection-*|promotion-*|approval-*|revalidation-*|revalidation-rollback-execute|revalidation-rollback-outcome|outcome-before-after|outcome-verify-runtime|enqueue]",
            readonly=False,
            category="基础",
        ),
        CommandMeta(
