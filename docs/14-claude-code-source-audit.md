...
- Workbench Reviews 的 Post-Rollback Behavioral Matrix 由 Python Projection Service 动态重验并通过 typed
  snapshot 同步；New UI 与 Textual fallback 只渲染总体 verdict、lane/evidence source 和未授权边界，不自行拼装
  Matrix 或扩大为长期/promotion authority。
