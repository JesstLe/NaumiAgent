...
非注入 Reflection。EVO-05.1a Input、EVO-05.1b Package 与 EVO-05.2a Approval Requirement 已完成，下一步是
EVO-05.2b Approval Request 与 EVO-05.2c1 Principal/Public-Key Authority 已完成；下一步是 EVO-05.2c2 签名回执。
