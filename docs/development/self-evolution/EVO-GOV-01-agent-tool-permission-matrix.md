...
| `evolution_capability_shadow_run_admission` | bounded Provider-call scope backed by exact Harness lease/grant; no call in this Tool | `evolution_capability_shadow` | 20 |
...
| `evolution_installation_key` | explicit OS-keyring installation identity provisioning | `evolution_release_identity` | 20 |
...
| `evolution_stable_remote_finalization` | signed grant, target pointer-CAS finalization, signed result ingest | `evolution_release_execution` | 50 |
