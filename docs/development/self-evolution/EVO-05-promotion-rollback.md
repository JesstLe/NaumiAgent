...
- EVO-05.2c2 Identity/Signature Receipt Authority：验证 current active key 对 exact domain payload 的签名，
  阻断撤销、旧 generation、过期与跨域重放。
...
当前完成 EVO-05.1a/1b、EVO-05.2a/2b 与 EVO-05.2c1。已有经用户确认的 Principal/role/public-key
authority，但尚无签名收集/验证、最终 approval decision、
