...
- EVO-03.3a 已从受管 candidate Lease 的精确文件状态读取同一 path，复用相同 metric/seed/order/平台
  合同并写入独立 GREEN batch；
- 下一最小切片是 EVO-03.4a Self-Review Quantitative Comparison Receipt，用 HAR-08.7d/H5c 冻结真实
  RED→GREEN 数值判定。
