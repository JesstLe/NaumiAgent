...
[EVO-05.5f5k](EVO-05-5f5k-stable-deployment-intent.md) 已冻结实现契约并交付 5f5k1：stable 必须以 current complete signed
Population 和逐安装 Ed25519 proof-of-possession 覆盖 100% 目标，不能复用 percentage selected cohort；Intent
Service/Store/View 仍为 partial。
