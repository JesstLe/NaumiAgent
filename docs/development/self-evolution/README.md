...
[EVO-05.5f5k](EVO-05-5f5k-stable-deployment-intent.md) 已冻结实现契约：stable 必须以 current complete signed Population 和
逐安装 proof-of-possession 覆盖 100% 目标，不能复用 percentage selected cohort；当前状态为 planned。
