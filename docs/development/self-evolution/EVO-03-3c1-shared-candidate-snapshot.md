...
Worker 完成后复验 Snapshot。EVO-03.3c2a 已抽出 RED/GREEN 共用的权限、ARC-04 与 H5a sample kernel；
EVO-03.3c2b 下一步接入 GREEN source/identity/metric/receipt。完整 cohort 编排仍留给后续独立切片。
