...
EVO-05.2a 已从 still-current Package 冻结角色、签名门、protected-scope 人工门和 expiry。EVO-05.2b 至
EVO-05.2c2 的 Role Response、Principal 与 Signature Receipt 也已完成；下一步是 EVO-05.2d Approval Decision
Aggregation。EVO-05.3 才负责
