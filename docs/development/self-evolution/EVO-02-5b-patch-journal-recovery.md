...
- 完整 Diff/API Postflight、EVO-02.7a Mutation Receipt Core 与 EVO-02.7b1 Mutation Generation Trace
  已在后续切片实现；2.7b2 Trace→Receipt v2 绑定和 HAR-08 RED/GREEN 尚未串联。
