...
| HAR-07 | Completion Receipt UI 与恢复 | partial (7.1a, 7.1b, 7.2, 7.3, 7.4a, 7.5a, 7.5b, 7.6) | HAR-05 | `harness/HAR-07-completion-ui.md` |
...
| UI-13 | Doctor/Debug 全屏诊断 | partial (13.1a-13.1d, 13.2a) | DebugTrace, heartbeat | `cli-ui/UI-13-diagnostics.md` |
| UI-14 | QuickOpen、Vim 与完整键位层 | partial (14.1a, 14.2a, 14.2b, 14.2c) | shared keybindings | `cli-ui/UI-14-navigation-input.md` |
...
| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| CC-01 | 源码采纳治理与映射更新 | partial (1.1a, 1.1b) | 当前 source map | `claude-source/CC-01-source-governance.md` |
...
| ARC-03 | 协议版本与兼容治理 | partial (3.2a, 3.2b1, 3.2b2, 3.4a) | 当前 JSONL | `architecture/ARC-03-protocol-versioning.md` |
...
| ARC-06 | 高并发、背压与集群调度 | partial (6.1a, 6.1b) | ARC-02, ARC-04 | `architecture/ARC-06-concurrency-cluster.md` |
