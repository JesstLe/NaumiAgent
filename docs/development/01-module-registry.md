...
| HAR-10 | 长周期 Harness Orchestration | partial (10.1a, 10.1b, 10.2a-10.2k, 10.3a, 10.3b1-10.3b5, 10.4a, 10.4b, 10.5a-10.5c, 10.6a-10.6d, 10.7a-10.7h6, 10.8a-10.8f2l, 10.9a) | HAR-06, HAR-08, ARC-06 | `harness/HAR-10-long-running.md` |

## CLI/TUI/New UI

| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| UI-10 | `/workbench` 命令页 | implemented (10.1-10.4, 10.5a, 10.5b1, 10.5b2, 10.6a, 10.6b1, 10.6b2, 10.6c-10.6e, 10.7, 10.8) | UI 协议、Runtime Inspector | `cli-ui/UI-10-workbench-page.md` |
...
| UI-17 | New UI/TUI parity 与发布门 | partial (17.1, 17.2a-17.2f, 17.3a-17.3c) | UI-10..16 | `cli-ui/UI-17-parity-release.md` |
| UI-18 | Goal/Pursuit 与恢复可视化 | partial (18.1, 18.2a, 18.3a, 18.4a, 18.4b, 18.4c, 18.4d1, 18.4d2, 18.4d3, 18.5a, 18.5b1) | ARC-01, HAR-10 | `cli-ui/UI-18-goal-pursuit.md` |
...
| CC-03 | Task/Permission/Doctor 组件迁入 | partial (3.1a, 3.1b, 3.2a) | CC-01, UI-11..13 | `claude-source/CC-03-component-alignment.md` |
...
| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| ARC-01 | Domain Boundary 与依赖防火墙 | partial (1.1-1.3f, 1.4a, 1.4b1, 1.4b2a-1.4b2j, 1.4c1-1.4c3) | 当前 Python 单体 | `architecture/ARC-01-domain-boundaries.md` |
...
| ARC-04 | Tool/Browser/Agent Daemon | partial (4.1a, 4.1b, 4.2a-4.2c, 4.3a-4.3c, 4.5a, 4.5b1, 4.5b1a, 4.5b2, 4.5c, 4.5d1, 4.5d2a-4.5d2d, 4.5e1-4.5e3b2, 4.6a) | ARC-02, ARC-03 | `architecture/ARC-04-execution-daemons.md` |
...
| ARC-07 | 跨平台闭源打包与更新 | partial (7.4a-7.4b、7.5a-7.5g、7.5c1 installation key 与 7.5c2 rollout-control signing root 已交付；其余以路线文档为准) | ARC-02, UI-17 | `architecture/ARC-07-packaging-update.md` |
...
| EVO-05 | 提升、回滚与发布治理 | partial (stable 路线已完成本机逐成员 5.5f5x3 binary finalization、5.5f5x3a–x3i 跨机链路、5.5f5x3j exact Population finalization、7b1–7b3c2 长期 Population assessment、7b4a–7b4d post-observation Decision、promoted/superseded ledger 与三端 typed projection；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；policy learning、完整 supersession 历史审计与配置/数据 rollback 仍未完成，以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
| EVO-06 | 持续学习与能力扩展 | partial (6.1a–6.1c4、6.2a–6.2c、6.3a、6.3b1、6.3b2a request、6.3b2b receipt、6.3b2c Registry lease、6.4a Shadow descriptor、6.4b Observation Contract、6.4c1a Run Admission 已实现；Observation Runner/aggregation、Activation/Selection/Retirement 待完成) | EVO-05, HAR-09 | `self-evolution/EVO-06-continuous-evolution.md` |
