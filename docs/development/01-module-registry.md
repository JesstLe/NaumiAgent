...
| HAR-09 | Feedback Candidate 与受控提升 | partial (9.1a-9.6c2a) | HAR-08, EVO-01.3a | `harness/HAR-09-feedback-promotion.md` |
| HAR-10 | 长周期 Harness Orchestration | partial (10.1a, 10.1b, 10.2a-10.2j, 10.3a, 10.3b1-10.3b5, 10.4a, 10.4b, 10.5a-10.5c, 10.6a-10.6c, 10.7a-10.7h6, 10.8a-10.8f2b) | HAR-06, HAR-08, ARC-06 | `harness/HAR-10-long-running.md` |
...
| UI-18 | Goal/Pursuit 与恢复可视化 | partial (18.1, 18.4a, 18.4b, 18.4c, 18.4d1, 18.4d2, 18.4d3, 18.5a, 18.5b1) | ARC-01, HAR-10 | `cli-ui/UI-18-goal-pursuit.md` |
...
| ARC-07 | 跨平台闭源打包与更新 | partial (7.4a-7.4b、7.5a-7.5e 已交付；其余以路线文档为准) | ARC-02, UI-17 | `architecture/ARC-07-packaging-update.md` |
...
| EVO-05 | 提升、回滚与发布治理 | partial (percentage/stable 路线至 5.5f5m；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
