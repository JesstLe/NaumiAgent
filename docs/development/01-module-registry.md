...
| EVO-05 | 提升、回滚与发布治理 | partial (stable 路线已完成本机逐成员 5.5f5x3 binary finalization，并以 5.5f5x3a 建立远端 installation identity claim；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；远端 runtime revalidation、Population rollout aggregation、配置/数据 finalization 与 promotion 仍未完成，以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
