...
| UI-17 | New UI/TUI parity 与发布门 | partial (17.1, 17.2a-17.2d, 17.3a) | UI-10..16 | `cli-ui/UI-17-parity-release.md` |
...
| EVO-02 | 隔离变异与补丁生成 | partial (2.1a-2.1b, 2.2a, 2.3a, 2.4a, 2.4b, 2.5a, 2.5b, 2.5c1, 2.5c2a, 2.5c2b, 2.6a, 2.6b, 2.7a, 2.7b1, 2.7b2, 2.7c1) | EVO-01, Worktree | `self-evolution/EVO-02-isolated-mutation.md` |
...
| EVO-04 | 反思决策与防奖励投机（EVO-04.1a Decision Input、4.2a Mechanical Gate 已完成） | partial | EVO-03 | `self-evolution/EVO-04-reflection-decision.md` |
