...
| HAR-08 | Eval Suite、Baseline 与回归比较 | partial (8.1a, 8.6a, 8.6b, 8.7a-8.7c) | HAR-05, ARC-03 | `harness/HAR-08-eval-baseline.md` |
...
| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| UI-10 | `/workbench` 命令页 | partial (10.1-10.2, 10.7) | UI 协议、Runtime Inspector | `cli-ui/UI-10-workbench-page.md` |
