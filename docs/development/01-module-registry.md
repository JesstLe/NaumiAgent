...
| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| ARC-01 | Domain Boundary 与依赖防火墙 | partial (1.1-1.3, 1.4a, 1.4b1, 1.4b2a-1.4b2g) | 当前 Python 单体 | `architecture/ARC-01-domain-boundaries.md` |
...
| ARC-04 | Tool/Browser/Agent Daemon | partial (4.1a, 4.1b, 4.2a) | ARC-02, ARC-03 | `architecture/ARC-04-execution-daemons.md` |
