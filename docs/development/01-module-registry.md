...
| ARC-03 | 协议版本与兼容治理 | partial (3.2a, 3.4a) | 当前 JSONL | `architecture/ARC-03-protocol-versioning.md` |
...
| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| EVO-01 | 自我审查证据与改进候选 | partial (1.1a, 1.1b, 1.2a, 1.3a) | Harness Evidence | `self-evolution/EVO-01-review-candidates.md` |
