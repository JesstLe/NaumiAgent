...
| HAR-08 | Eval Suite、Baseline 与回归比较 | partial (8.1a, 8.3a, 8.4a-8.4o3j, 8.6a, 8.6b, 8.7a-8.7e, H5a-H5c, H5b2, 8.8a-8.8e3) | HAR-05, ARC-03, ARC-04 | `harness/HAR-08-eval-baseline.md` |
| HAR-09 | Feedback Candidate 与受控提升 | partial (9.1a-9.5c) | HAR-08, EVO-01.3a | `harness/HAR-09-feedback-promotion.md` |
| HAR-10 | 长周期 Harness Orchestration | partial (10.1a, 10.1b, 10.2a-10.2h, 10.3a, 10.3b1-10.3b5, 10.4a, 10.4b, 10.5a-10.5c, 10.6a, 10.6b, 10.7a, 10.7b, 10.8a) | HAR-06, HAR-08, ARC-06 | `harness/HAR-10-long-running.md` |
...
| ARC-04 | Tool/Browser/Agent Daemon | partial (4.1a, 4.1b, 4.2a-4.2c, 4.3a-4.3c, 4.5a, 4.5b1, 4.5b1a, 4.5b2, 4.5c) | ARC-02, ARC-03 | `architecture/ARC-04-execution-daemons.md` |
| ARC-05 | 状态 Schema 与迁移平台 | partial (5.1, 5.2a) | ARC-01 | `architecture/ARC-05-state-migrations.md` |
| ARC-06 | 高并发、背压与集群调度 | partial (6.1a, 6.1b, 6.2a, 6.2b1, 6.2b2) | ARC-02, ARC-04 | `architecture/ARC-06-concurrency-cluster.md` |
