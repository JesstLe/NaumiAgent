...
| EVO-05 | 提升、回滚与发布治理 | partial (percentage/stable 路线至 5.5f5q；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
