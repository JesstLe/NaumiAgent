...
| EVO-06 | 持续学习与能力扩展 | partial (6.1a–6.1c4、6.2a–6.2c、6.3a、6.3b1、6.3b2a request、6.3b2b receipt、6.3b2c Registry lease、6.4a Shadow descriptor、6.4b Observation Contract 已实现；Observation Runner/aggregation、Activation/Selection/Retirement 待完成) | EVO-05, HAR-09 | `self-evolution/EVO-06-continuous-evolution.md` |
