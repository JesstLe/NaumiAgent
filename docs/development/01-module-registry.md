...
| EVO-05 | 提升、回滚与发布治理 | partial (stable 路线已完成本机逐成员 5.5f5x3 binary finalization、5.5f5x3a 远端 installation identity claim、5.5f5x3b fresh Release Store probe、5.5f5x3c signed authorization 与 5.5f5x3d target CAS/signed result ingest；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；自动远端 delivery/recovery、Population rollout aggregation、配置/数据 finalization 与 promotion 仍未完成，以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
