...
| EVO-05 | 提升、回滚与发布治理 | partial (stable 路线已完成本机逐成员 5.5f5x3 binary finalization、5.5f5x3a–x3i 的跨机身份/探测/授权/双向 mTLS/daemon 链路，以及 5.5f5x3j exact Population finalization Receipt 聚合与动态撤权；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；配置/数据 finalization、跨控制面 Population Receipt signature/transparency 与 promotion 仍未完成，以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
