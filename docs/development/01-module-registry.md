...
| EVO-05 | 提升、回滚与发布治理 | partial (stable 路线已完成本机逐成员 5.5f5x3 binary finalization、5.5f5x3a–x3i 的跨机身份/探测/授权/双向 mTLS/daemon 链路、5.5f5x3j exact Population finalization、7b1 Observation Contract、7b2 managed Runtime Admission 与 7b2a1 current-Credential signed delivery Receipt；installed-slot rollback 与 Proposal-bound rolled_back Outcome 至 5.7a；Admission authenticated network worker、长期 Population assessment、配置/数据 rollback 与 promoted/superseded Outcome 仍未完成，以路线文档为准) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
