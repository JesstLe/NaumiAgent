...
| UI-17 | New UI/TUI parity 与发布门 | partial (17.1, 17.2a-17.2e, 17.3a) | UI-10..16 | `cli-ui/UI-17-parity-release.md` |
...
| CC-05 | 上游差异监控与行为回归 | partial (5.1) | CC-01 | `claude-source/CC-05-upstream-regression.md` |
...
| EVO-05 | 提升、回滚与发布治理 | partial (5.1a, 5.1b, 5.2a-5.2d) | EVO-04, ARC-07 | `self-evolution/EVO-05-promotion-rollback.md` |
