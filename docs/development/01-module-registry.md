...
| HAR-06 | Session 生命周期与派生数据清理 | partial (6.1, 6.2a-6.2c, 6.3a-6.3b, 6.6a) | HAR-05 | `harness/HAR-06-session-lifecycle.md` |
| HAR-07 | Completion Receipt UI 与恢复 | partial (7.1a-7.4a) | HAR-05 | `harness/HAR-07-completion-ui.md` |
| HAR-08 | Eval Suite、Baseline 与回归比较 | partial (8.1a) | HAR-05, ARC-03 | `harness/HAR-08-eval-baseline.md` |
...
| ID | 名称 | 状态 | 依赖 | 文档 |
| --- | --- | --- | --- | --- |
| UI-10 | `/workbench` 命令页 | partial (10.1-10.2) | UI 协议、Runtime Inspector | `cli-ui/UI-10-workbench-page.md` |
| UI-11 | 全屏任务与 Timeline 导航 | partial (11.2a) | Agent Control Center | `cli-ui/UI-11-task-navigation.md` |
...
| ARC-05 | 状态 Schema 与迁移平台 | partial (5.1) | ARC-01 | `architecture/ARC-05-state-migrations.md` |
