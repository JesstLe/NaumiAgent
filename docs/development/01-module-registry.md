...
| HAR-07 | Completion Receipt UI 与恢复 | partial (7.1a, 7.1b, 7.2, 7.3, 7.4a, 7.6) | HAR-05 | `harness/HAR-07-completion-ui.md` |
...
| EVO-03 | 多层验证与 Eval 对照 | partial (3.1a, 3.1b, 3.2a-3.2g, 3.3a-3.3c2c2, 3.4a-3.4b, 3.5a-3.5b, 3.6a-3.6e) | EVO-02, HAR-08 | `self-evolution/EVO-03-validation-evaluation.md` |
