...
| HAR-06 | `harness/retention.py`, `retention_planner.py`, `retention_executor.py`, `artifact_gc.py`, Session reconciliation | retention、artifact safety、session deletion integration |
