...
HAR-08.4i/4j 已补齐通用 Service、Tool 与共享 Slash；HAR-08.4 仍为 partial：New UI/TUI typed progress、
跨进程 Batch admission 和 Linux/Windows CI 尚未完成。EVO-03.6 后续只接入现有 Batch coordinator 与 H5c，
不能复制执行循环。
