...
- HAR-10.8 Terminal decision：完成、waiting、blocked、cancelled、budget_exceeded。
  ...
  - 未完成：outbox cursor/claim/backoff 自动扫描、跨 Store 原子 terminal commit 与 A5 故障/soak 验证。
...
自动 terminal outbox worker、历史 cursor/retention 与 takeover/cleanup 仍待独立治理；10.8f1 已提供
worker 所需的原子 pending/delivered Store 边界，但不能代替自动消费。
