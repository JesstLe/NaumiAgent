...
Runtime authority callback 内核，但生产调度与完整 Supervisor 运维仍未完成。详见
...
`../architecture/ARC-04-5e3b1-encrypted-agent-tool-rpc.md`。HAR-10.7g 又以 Store schema v6 的 HMAC quarantine
...
执行内核；生产调度、完整 Supervisor、完整 Worker、
