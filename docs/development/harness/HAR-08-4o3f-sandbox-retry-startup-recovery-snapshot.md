...
- retry dispatch retention preview 已由 HAR-08.4o3h 交付，4o3i 已交付 prune receipt；
  receipt consumption/执行仍未实现；
- 跨主机 Sandbox admission；
- macOS/Linux/Windows 三平台真实隔离 Worker CI。

HAR-08.4o3g/4o3h 已交付只读详情、完整 protection refs 与有界 retention preview，4o3i 已交付
显式 prune receipt authority。下一切片 4o3j 才能消费回执并原子执行清理，不能因为队列、preview
或 accepted receipt 已可见就自动删除 dispatch。
