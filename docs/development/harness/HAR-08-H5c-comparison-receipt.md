...
把 H5a 的两组精确 Eval samples、H5b 的 promoted/reference Baseline 版本、HAR-08.7b 的机械变化、8.7c 的
...
H5b2 已允许把预期失败但 Identity/guardrail 可信的 RED cohort 注册为 `comparison_reference`。该记录不切换
active selector，H5c 的样本重读、摘要校验和 verdict 规则与 promoted Baseline 完全相同。
