...
- CC-03.2a 已完成三个 Bridge snapshot 的字段和值域映射，CC-03.2b 随后完成 14 个 UI-local 状态的
  可执行映射；详见 `CC-03-2a-snapshot-semantic-mapping.md` 与 `CC-03-2b-ui-local-state-mapping.md`。
