...
- 单元测试验证全部规范绝对路径、用户状态目录未被创建、relative/escape 拒绝；
...
- ARC-01.4b2i 已完成：ToolJobStore 作为 ARC-04.2b admission authority 资源迁入；
- ARC-01.4b2j 已完成：Shell Worker transport、sandbox 与 artifact typed paths 迁入且保持惰性；
