...
ARC-01.4c2-4c3 已分别让 New UI Bridge 与 TUI 消费共享 factory，删除两端 producer/retention 私有构造。下一步应回到
跨文档依赖选择：UI-17 capability/golden parity 或 ARC-01 其余 Service 迁移均可消费该前置；ARC-01.4d 全局关闭注册表
完成前，ARC-02 仍不得开始。
