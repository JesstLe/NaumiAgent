...
idempotency key 与 active Worker epoch。ARC-04.2b 又完成 immutable ToolJob admission；下一步仍需
ARC-04.2c durable lifecycle/completion receipt。ARC-04.3 真实 Shell daemon 与 ARC-04.6 Supervisor 尚未完成，
