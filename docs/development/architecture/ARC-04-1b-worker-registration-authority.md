...
idempotency key 与 active Worker epoch。ARC-04.2b/2c 又完成 immutable ToolJob admission 与 durable
lifecycle/completion receipt。ARC-04.3 真实 Shell daemon 与 ARC-04.6 Supervisor 尚未完成，
