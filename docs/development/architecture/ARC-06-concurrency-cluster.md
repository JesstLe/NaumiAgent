...
- ARC-06.2 Scheduler（partial）：
  ...
  - ARC-04.5b1 已提供 OS credential-backed Runtime payload key 与 authenticated envelope，但尚无
    Agent Job Store 消费者；因此 scheduler 仍不能恢复派发。见
    [设计与验证](ARC-04-5b1-runtime-payload-envelope.md)。
