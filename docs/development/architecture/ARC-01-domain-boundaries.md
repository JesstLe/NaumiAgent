...
| ARC-01.4 Composition root | 设计完成，4a 待实现 | [总体设计](ARC-01-4-composition-root-design.md) · [4a Runtime Ports Composition 设计](ARC-01-4a-runtime-ports-composition-design.md)；五个真实 Port 已就绪 |
