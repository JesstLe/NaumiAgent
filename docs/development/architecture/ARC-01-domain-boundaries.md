...
| ARC-01.3 Ports | 进行中 | SessionPort、PermissionPort、ModelPort 已实现；ModelPort：[生产](../../../src/naumi_agent/runtime/ports/model.py) · [测试](../../../tests/unit/test_model_port.py) · [设计](ARC-01-3c-model-port-design.md) · [计划](ARC-01-3c-model-port-implementation-plan.md)；ToolExecutionPort、EventSink 待开发 |
