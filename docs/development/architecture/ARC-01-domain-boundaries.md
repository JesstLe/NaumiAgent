...
| ARC-01.3 Ports | 进行中 | SessionPort 已实现：[生产](../../../src/naumi_agent/runtime/ports/session.py) · [设计](ARC-01-3a-session-port-design.md) · [计划](ARC-01-3a-session-port-implementation-plan.md)；PermissionPort：[设计](ARC-01-3b-permission-port-design.md) · [计划](ARC-01-3b-permission-port-implementation-plan.md)；其余三个 Port 待开发 |
