...
| ARC-01.3 Ports | 进行中 | SessionPort 已实现；PermissionPort 已实现：[生产](../../../src/naumi_agent/runtime/ports/permission.py) · [测试](../../../tests/unit/test_permission_port.py) · [设计](ARC-01-3b-permission-port-design.md) · [计划](ARC-01-3b-permission-port-implementation-plan.md)；ModelPort、ToolExecutionPort、EventSink 待开发 |
