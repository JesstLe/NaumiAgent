...
| ARC-01.3 Ports | 进行中 | SessionPort、PermissionPort 已实现；ModelPort：[设计](ARC-01-3c-model-port-design.md) · [计划](ARC-01-3c-model-port-implementation-plan.md)；ToolExecutionPort、EventSink 待开发 |
