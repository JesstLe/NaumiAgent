...
| ARC-01.4 Composition root | 4a 已实现，4b 待开发 | [总体设计](ARC-01-4-composition-root-design.md) · [4a 设计与验收审计](ARC-01-4a-runtime-ports-composition-design.md) · [4a 实施计划](ARC-01-4a-runtime-ports-composition-implementation-plan.md)；五个默认 Port adapter 已由唯一 root 装配，Store/Resource 尚未迁移 |
