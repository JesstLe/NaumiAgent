...
schema v4 投影 claimed/running/unknown 与 pending/expired publication 的只读恢复目录。Agent 仍不是 daemon，周期
publication retry、Agent/Browser 持久 Worker、priority/公平调度与跨主机 topology 尚未实现，因此
ARC-06 保持 partial。
