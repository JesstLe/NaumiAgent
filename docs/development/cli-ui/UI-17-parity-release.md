...
- UI-17.1 Capability manifest：每个前端声明协议版本和 capability。
...
SQLite 验证两端 heartbeat/retention/Doctor/terminal 语义。该前置解决运行时对象图差异，但不等于 UI-17.1 capability
manifest 或 UI-17.2 golden scenarios 已完成；下一步应建立可机读 manifest 和同一 fixture 的语义字段对照。
