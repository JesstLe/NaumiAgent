...
按权限/Git/Harness/Agent/工具分类并保留语义色。UI-10.5b 又补齐独立持久 stream/cursor、Bridge 订阅与
断线 replay、New UI 连续 reducer 和 Textual 同源刷新；gap 强制完整快照且不推进 Dashboard revision。
