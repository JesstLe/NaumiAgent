...
| 04 Inspector 与命令页 | M5 Runtime Inspector：后端五标签权威快照、revision 增量/断序恢复、三档响应式新 UI、UI state v4、Textual 同源全屏页、真实 Git/TaskStore/pytest/SQLite 跨前端验收 | M6 分别实现 `/agents`、`/workbench`；随后补 Inspector 写操作 |
