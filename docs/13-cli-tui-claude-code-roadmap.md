...
### 1. 直接复制 Claude Code 源码风险高

当前本地 `claude-code` 仓库没有 LICENSE 文件。最稳妥做法是架构迁移、行为复刻、Naumi 原生实现。

### 2. prompt_toolkit 和 Textual 双 UI 维护成本高
...
### 5. 中文、emoji、terminal width 是硬问题
