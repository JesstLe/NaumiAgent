...
| Harness | `/harness status` `/harness eval` `/harness eval <suite> --repeat 5` `/harness baseline <suite>` `/harness explain` `/harness replay` | 查看工程契约、生成重复 Candidate、读取权威 Baseline/比较、解释并安全回放运行 |
